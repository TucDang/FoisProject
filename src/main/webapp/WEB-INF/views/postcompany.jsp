...
<!-- banner -->
  <div  >
  	 <img width="100%" height="100%" src="resources/images/event.jpg" class="img-responsive" alt=""/>
  </div>
	...
	<div class="courses_box1">
	   <div class="container">
		...
		<div><h2>Đăng Công Việc Mới</h2></div>
		<div class="courses_box1-left">
		<table>
		 <tr>
		 <td>Tên Công Việc &nbsp;</td>
   ...
   <option value="SG">Singapore</option>
		...
		<tr> <td> &nbsp;</td></tr>
		 ...
		 <td>Mô Tả Công Việc &nbsp;</td>
      		<td><textarea id="address" name="address" rows="5" cols="60"></textarea></td>
		 </tr>
		 <tr><td><div style= "text-align:center!important" ><input type="submit" value="Đăng bài" class="course-submit" ></div></td></tr>
   </table>  
   </div>
  		 <br/>
  		 <br/>
		<div><h2>Thông Tin Công Ty</h2></div>
	      <div class="courses_box1-left">
   	 ...
   	 <div><h2>Công Việc Đang Diễn Ra</h2></div>
     <div class="grid_2">
